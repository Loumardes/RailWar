...
execute if entity @s[tag=setoff,tag=blue] unless entity @e[type=marker,tag=blue_crystal,distance=..20,limit=1] run function loumardes:railrush/detonate_tntcart
execute if entity @s[tag=setoff,tag=blue] if entity @e[type=marker,tag=blue_crystal,distance=..20,limit=1] run tag @s remove setoff
execute if entity @s[tag=setoff,tag=red] unless entity @e[type=marker,tag=red_crystal,distance=..20,limit=1] run function loumardes:railrush/detonate_tntcart
execute if entity @s[tag=setoff,tag=red] if entity @e[type=marker,tag=red_crystal,distance=..20,limit=1] run tag @s remove setoff
