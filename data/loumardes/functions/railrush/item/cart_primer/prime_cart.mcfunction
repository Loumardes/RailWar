...
execute positioned ~-0.5 ~-0.5 ~-0.5 unless entity @e[type=command_block_minecart, tag=TNTcart,dx=0,dy=-0.5,dz=0,limit=1] positioned ~0.5 ~0.5 ~0.5 unless score @s Process matches 10.. positioned ^ ^ ^0.5 run function loumardes:railrush/item/cart_primer/prime_cart
