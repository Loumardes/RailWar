...
execute as @e[type=chest_minecart, tag=TNTcart,dx=0,dy=-0.5,dz=0,limit=1] unless score @s TNTFuse matches -2147483648..2147483647 run scoreboard players set @s TNTFuse 80
execute if entity @e[type=chest_minecart, tag=TNTcart,dx=0,dy=-0.5,dz=0,limit=1] unless score @s TNTFuse matches -2147483648..2147483647 run particle flame ~ ~ ~ 0.5 0.5 0.5 0.01 20 normal
