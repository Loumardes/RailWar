...
item replace entity @s armor.head with leather_helmet{Unbreakable:1,display:{color:13697026}} 1 
item replace entity @s armor.feet with leather_boots{Unbreakable:1,display:{color:13697026}} 1 
