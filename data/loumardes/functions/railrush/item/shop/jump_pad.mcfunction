...
execute if entity @s[team=blue] if score Blue gold matches 5.. run give @s emerald_block{display:{Name:'[{"text":"Jump Pad","italic":false}]',Lore:['[{"text":"Works on Minecarts and players alike","italic":true}]']}} 1
...
execute if entity @s[team=red] if score Red gold matches 5.. run give @s emerald_block{display:{Name:'[{"text":"Jump Pad","italic":false}]',Lore:['[{"text":"Works on Minecarts and players alike","italic":true}]']}} 1
...
execute if entity @s[team=spectator] if score Spectators gold matches 5.. run give @s emerald_block{display:{Name:'[{"text":"Jump Pad","italic":false}]',Lore:['[{"text":"Works on Minecarts and players alike","italic":true}]']}} 1
