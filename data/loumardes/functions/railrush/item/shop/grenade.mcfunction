...
execute if entity @s[team=blue] if score Blue gold matches 5.. run give @s minecraft:splash_potion{Potion:"minecraft:water",CustomPotionEffects:[{Id:7,Amplifier:2}],display:{Name:"\"Grenade\""}} 1
...
execute if entity @s[team=red] if score Red gold matches 5.. run give @s minecraft:splash_potion{Potion:"minecraft:water",CustomPotionEffects:[{Id:7,Amplifier:2}],display:{Name:"\"Grenade\""}} 1
