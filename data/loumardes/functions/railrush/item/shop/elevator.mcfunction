...
execute if entity @s[team=blue] if score Blue gold matches 1.. run give @s vine 16
...
execute if entity @s[team=red] if score Red gold matches 1.. run give @s vine 16
